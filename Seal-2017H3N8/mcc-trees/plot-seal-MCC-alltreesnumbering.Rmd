...
pseg2 <- pseg2 %<+% dd +
  geom_hilight(node = 73, fill = "gray", alpha = 0.5) + 
  geom_segment2(aes(subset = isTip, xend = max(x) - .001, yend = y), linetype = "dotted", size = .3) +
  geom_text2(aes(subset = isTip, label = newlab, x = max(x)), size = 3, hjust = -.025) +
  geom_tippoint(aes(color = colourName, shape = source), size = 2.2) +
  scale_color_manual(values=mypalette, labels=mylabels) +
  ...
  geom_point2(aes(subset =  !is.na(posterior), fill = posterior), shape = 23, size = 1.5) +
  scale_fill_continuous(high = "black", low= "white", breaks=c(0,0.5,1),labels=c(0.0,0.5,1.0),limits=c(0,1)) +
  geom_text2(aes(subset = node==73, label = round(decimal_date(seg2_mrsd) - height_median,2)), hjust = 1.1, vjust = -0.5, size = 1.8) +
  ggtitle(paste("(B) PB1")) +
  labs(colour = "Host", shape = "Source", fill = "Posterior support") +
  guides(shape = guide_legend(title = "Source", order = 1),
         colour = guide_legend(title = "Host", order = 2),
...
pseg3 <- pseg3 %<+% dd +
  geom_hilight(node = 76, fill = "gray", alpha = 0.5) + 
  geom_segment2(aes(subset = isTip, xend = max(x) - .001, yend = y), linetype = "dotted", size = .3) +
  geom_text2(aes(subset = isTip, label = newlab, x = max(x)), size = 3, hjust = -.025) +
  geom_tippoint(aes(color = colourName, shape = source), size = 2.2) +
  scale_color_manual(values=mypalette, labels=mylabels) +
  ...
  geom_point2(aes(subset =  !is.na(posterior), fill = posterior), shape = 23, size = 1.5) +
  scale_fill_continuous(high = "black", low= "white", breaks=c(0,0.5,1),labels=c(0.0,0.5,1.0),limits=c(0,1)) +
  geom_text2(aes(subset = node==76, label = round(decimal_date(seg3_mrsd) - height_median,2)), hjust = -0.2, vjust = 0.2, size = 1.8) +
  ggtitle(paste("(C) PA")) +
  labs(colour = "Host", shape = "Source", fill = "Posterior support") +
  guides(shape = guide_legend(title = "Source", order = 1),
         colour = guide_legend(title = "Host", order = 2),
...
pseg5 <- pseg5 %<+% dd +
  geom_hilight(node = 72, fill = "gray", alpha = 0.5) + 
  geom_segment2(aes(subset = isTip, xend = max(x) - .001, yend = y), linetype = "dotted", size = .3) +
  geom_text2(aes(subset = isTip, label = newlab, x = max(x)), size = 3, hjust = -.025) +
  geom_tippoint(aes(color = colourName, shape = source), size = 2.2) +
  scale_color_manual(values=mypalette, labels=mylabels) +
  ...
  geom_point2(aes(subset =  !is.na(posterior), fill = posterior), shape = 23, size = 1.5) +
  scale_fill_continuous(high = "black", low= "white", breaks=c(0,0.5,1),labels=c(0.0,0.5,1.0),limits=c(0,1)) +
  geom_text2(aes(subset = node==72, label = round(decimal_date(seg5_mrsd) - height_median,2)), hjust = 1.1, vjust = -0.5, size = 1.8) +
  ggtitle(paste("(E) NP")) +
  labs(colour = "Host", shape = "Source", fill = "Posterior support") +
  guides(shape = guide_legend(title = "Source", order = 1),
         colour = guide_legend(title = "Host", order = 2),
...
pseg7 <- pseg7 %<+% dd +
  geom_hilight(node = 93, fill = "gray", alpha = 0.5) + 
  geom_segment2(aes(subset = isTip, xend = max(x) - .001, yend = y), linetype = "dotted", size = .3) +
  geom_text2(aes(subset = isTip, label = newlab, x = max(x)), size = 3, hjust = -.025) +
  geom_tippoint(aes(color = colourName, shape = source), size = 2.2) +
  scale_color_manual(values=mypalette, labels=mylabels) +
  ...
  geom_point2(aes(subset =  !is.na(posterior), fill = posterior), shape = 23, size = 1.5) +
  scale_fill_continuous(high = "black", low= "white", breaks=c(0,0.5,1),labels=c(0.0,0.5,1.0),limits=c(0,1)) +
  geom_text2(aes(subset = node==93, label = round(decimal_date(seg7_mrsd) - height_median,2)), hjust = -0.2, vjust = 0.3, size = 1.8) +
  ggtitle(paste("(G) MP")) +
  labs(colour = "Host", shape = "Source", fill = "Posterior support") +
  guides(shape = guide_legend(title = "Source", order = 1),
         colour = guide_legend(title = "Host", order = 2),
...
pseg8 <- pseg8 %<+% dd +
  geom_hilight(node = 61, fill = "gray", alpha = 0.5) + 
  geom_segment2(aes(subset = isTip, xend = max(x) - .001, yend = y), linetype = "dotted", size = .3) +
  geom_text2(aes(subset = isTip, label = newlab, x = max(x)), size = 3, hjust = -.025) +
  geom_tippoint(aes(color = colourName, shape = source), size = 2.2) +
  scale_color_manual(values=mypalette, labels=mylabels) +
  ...
  geom_point2(aes(subset =  !is.na(posterior), fill = posterior), shape = 23, size = 1.5) +
  scale_fill_continuous(high = "black", low= "white", breaks=c(0,0.5,1),labels=c(0.0,0.5,1.0),limits=c(0,1)) +
  geom_text2(aes(subset = node==61, label = round(decimal_date(seg8_mrsd) - height_median,2)), hjust = -0.2, vjust = 0.3, size = 1.8) +
  ggtitle(paste("(H) NS")) +
  labs(colour = "Host", shape = "Source", fill = "Posterior support") +
  guides(shape = guide_legend(title = "Source", order = 1),
         colour = guide_legend(title = "Host", order = 2),
